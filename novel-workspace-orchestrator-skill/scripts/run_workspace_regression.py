...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run read-only regression checks against fixed novel workspaces."
    )
    parser.add_argument(
        "--cases",
        default=str(DEFAULT_CASES),
        help="JSON file listing regression cases. Defaults to the built-in seven-sample fixture.",
    )
    parser.add_argument(
        "--project-root",
